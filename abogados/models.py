...
class DbAbogados(models.Model):
    ...
    ciudadexpedicion = models.ForeignKey(Municipio, db_column='ciudadExpedicion', blank=True, null=True, related_name='DbAbogados.ciudadexpedicion+', on_delete=models.PROTECT)  # Field name made lowercase.
